...
def construct_variables():
	...
	for idx in os.listdir("./extracted"):
		...
		with open("./extracted/" + idx, "r") as f:
			...
			scaling_size_diff_list.append(scaling_size_diff)
			...
			gaussian_mean_vector_angle_diff_list.append(gaussian_mean_vector_angle_diff)
			gaussian_mean_vector_angle_average_list.append(gaussian_mean_vector_angle_average)
